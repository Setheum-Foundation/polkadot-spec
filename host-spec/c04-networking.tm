...
<\body>
  ...
  is incomplete and is considered a work in progress. Any reports or
  clarifications regarding the deviation from the current Polkadot network
  protocol are appreciated.
  ...
  details of the used <verbatim|libp2p> protocols are specified in external
  ...
  <\definition>
    ...
    <\itemize-dot>
      ...
      all desired fields withbitwise OR operations. For example, the
